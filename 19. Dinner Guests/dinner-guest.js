"use strict";
let invite = ['Asher', 'Mohib', 'Arbaz', 'laila']; //In bando ko bulaya mene
/*
...
*/
let absentguest = ['Asher', 'laila']; //ye dono nahi aye
let newguest = ['Kamran', 'Imran']; //inke jaga mene inko bula lia
...
console.log(invite);
//Exercise 19
//print a masssage indicating the number of people you are inviting to dinner
console.log(`Total number of Guests are: ${invite.length}`);
